...
export default function Flower() {
    ...
    useEffect(() => {
        ...
        function resetAnimation() {
            ...
            // Reset all sides
            KUTE.fromTo("#leftSide", { translateX: 0, rotate: 0 }, { translateX: 0, rotate: 0 }, { duration: 2000 }).start();
        ...
        function slideLeft() {
            ...
            KUTE.fromTo("#leftSide", { rotate: 0, translate3d: [0, 0, 0] }, { rotate: 360, translate3d: [350, 0, 1] }, { duration: 2000 }).start();
        ...
        function slideRight() {
            ...
            KUTE.fromTo("#rightSide", { rotate: 0, translate3d: [0, 0, 0] }, { rotate: 360, translate3d: [-350, 0, 1] }, { duration: 2000 }).start();
        ...
        function slideDown() {
            ...
            KUTE.fromTo("#bottomSide", { rotate: 0, translate3d: [0, 0, 0] }, { rotate: 360, translate3d: [0, 350, 1] }, { duration: 2000 }).start();
    ...
    return (
        <div className={styles.container} style={{ position: "relative" }}>
            <div style={{ display: 'flex' }}>
                ...
                <button type="button" id="slideLeftButton">Slide Left</button>
                <button type="button" id="slideRightButton">Slide Right</button>
                <button type="button" id="slideUpButton">Slide Up</button>
                <button type="button" id="slideDownButton">Slide Down</button>
            </div>
