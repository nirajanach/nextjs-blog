...
export default function Flower() {
    ...
    useEffect(() => {
        ...
        function slideLeft() {
            ...
            "M 209.59 81.702 H 298.995 A 10 10 0 0 1 308.995 91.702 V 113.561 A 10 10 0 0 1 298.995 123.561 H 209.59 A 10 10 0 0 1 199.59 113.561 V 91.702 A 10 10 0 0 1 209.59 81.702 Z";
          
            const rectanglePath2 = 
            "M 206.302 74 H 302.601 A 14.302 14.302 0 0 1 316.903 88.302 V 116.906 A 14.302 14.302 0 0 1 302.601 131.208 H 206.302 A 14.302 14.302 0 0 1 192 116.906 V 88.302 A 14.302 14.302 0 0 1 206.302 74 Z M 200.735 92.348 V 112.86 A 9.935 9.935 0 0 0 210.67 122.795 H 298.234 A 9.935 9.935 0 0 0 308.168 112.86 V 92.348 A 9.935 9.935 0 0 0 298.234 82.413 H 210.67 A 9.935 9.935 0 0 0 200.735 92.348 Z";
            
            const rectanglePath3 = 
            "M 209.3 377 H 308.7 A 14.3 14.3 0 0 1 323 391.3 V 423.7 A 14.3 14.3 0 0 1 308.7 438 H 209.3 A 14.3 14.3 0 0 1 195 423.7 V 391.3 A 14.3 14.3 0 0 1 209.3 377 Z M 204 396.397 V 418.603 A 9.8 9.8 0 0 0 213.8 428.403 H 304.2 A 9.8 9.8 0 0 0 314 418.603 V 396.397 A 9.8 9.8 0 0 0 304.2 386.597 H 213.8 A 9.8 9.8 0 0 0 204 396.397 Z";
          
            const innerBottomFrame = 
            "M 214.067 384 L 302.933 384 C 310.149 384 316 389.673 316 396.67 L 316 418.33 C 316 425.327 310.149 431 302.933 431 L 214.067 431 C 206.851 431 201 425.327 201 418.33 L 201 396.67 C 201 389.673 206.851 384 214.067 384 Z";

            const outerRightFrame = 
            "M 349.3 223 H 448.7 A 14.3 14.3 0 0 1 463 237.3 V 269.7 A 14.3 14.3 0 0 1 448.7 284 H 349.3 A 14.3 14.3 0 0 1 335 269.7 V 237.3 A 14.3 14.3 0 0 1 349.3 223 Z M 344 242.397 V 264.603 A 9.8 9.8 0 0 0 353.8 274.403 H 444.2 A 9.8 9.8 0 0 0 454 264.603 V 242.397 A 9.8 9.8 0 0 0 444.2 232.597 H 353.8 A 9.8 9.8 0 0 0 344 242.397 Z";

            const innerRightRect = 
            "M 354.067 230 L 442.933 230 C 450.149 230 456 235.673 456 242.67 L 456 264.33 C 456 271.327 450.149 277 442.933 277 L 354.067 277 C 346.851 277 341 271.327 341 264.33 L 341 242.67 C 341 235.673 346.851 230 354.067 230 Z";


            const outerLeftFrame = 
            "M 56.3 218 H 183.7 A 14.3 14.3 0 0 1 198 232.3 V 264.7 A 14.3 14.3 0 0 1 183.7 279 H 56.3 A 14.3 14.3 0 0 1 42 264.7 V 232.3 A 14.3 14.3 0 0 1 56.3 218 Z M 52.97 236.412 V 260.588 A 8.815 8.815 0 0 0 61.785 269.403 H 178.215 A 8.815 8.815 0 0 0 187.03 260.588 V 236.412 A 8.815 8.815 0 0 0 178.215 227.597 H 61.785 A 8.815 8.815 0 0 0 52.97 236.412 Z";

            const innerLeftRect = 
            "M 66.681 225 L 173.319 225 C 181.979 225 189 230.673 189 237.67 L 189 259.33 C 189 266.327 181.979 272 173.319 272 L 66.681 272 C 58.021 272 51 266.327 51 259.33 L 51 237.67 C 51 230.673 58.021 225 66.681 225 Z";
           
            var morphTween11 = KUTE.to('#innerTop' ,  { path: rectanglePath1 }, {
                duration: 1500, easing: 'easingCubicOut'
              });


              var morphTween12 = KUTE.to('#outerTop' ,  { path: rectanglePath2 , attr:{ fill: "#caacb9" } }, {
                duration: 1500, easing: 'easingCubicOut'
              });
        

              var morphTween31 = KUTE.to('#outerBottom' ,  { path: rectanglePath3 }, {
                duration: 1500, easing: 'easingCubicOut'
              });
              var morphTween32 = KUTE.to('#innerBottom' ,  { path: innerBottomFrame }, {
                duration: 1500, easing: 'easingCubicOut'
              });
        
              var morphTween21 = KUTE.to('#outerLeft' ,  { path: outerRightFrame , attr:{ fill: "#1fbcc5" } }, {
                duration: 1500, easing: 'easingCubicOut'
              });
        
              var morphTween22 = KUTE.to('#innerLeft' ,  { path: innerRightRect , attr:{ fill: "#158085" } }, {
                duration: 1500, easing: 'easingCubicOut'
              });
        
              var morphTween41 = KUTE.to('#innerRight' ,  { path: innerLeftRect , attr:{ fill: "#e0433a" } }, {
                duration: 1500, easing: 'easingCubicOut'
              });

              var morphTween42 = KUTE.to('#outerRight' ,  { path: outerLeftFrame , attr:{ fill: "#ea7f7a" } }, {
                duration: 1500, easing: 'easingCubicOut'
              });
        ...
        function slideRight() {
            ...
            KUTE.fromTo("#rightSide",  { rotate: 0, translateX:0 }, { rotate:360 ,translateX: -350 }, { duration: 2000 }).start();
            ...
            <svg id="svgContainer"
                ...
                <g id="content" style={{transformOrigin: "center"}} >
                    <g transform="translate(-4.40941-1.77001)"  >
                        <g id="leftSide" className="side" style={{transformOrigin: "left"}}>
                            <path id="outerLeft" d="M256,255.5v.5c333.3,361,333.3-361.6,0-.5Z" fill="#1fbcc5" />
                            <path id="innerLeft" d="M283.3,255.7c34.7-35.6,66.9-60.3,96-73.6c25.2-11.5,46.9-13.9,64.3-7.1c16.1,6.3,25.7,19.6,30.9,29.7c7.4,14.3,11.5,32.4,11.5,51c0,18.5-4.1,36.6-11.5,51-5.2,10.1-14.8,23.4-30.9,29.7-17.4,6.8-39,4.4-64.3-7.1-29.1-13.3-61.3-38-96-73.6Z" fill="#158085" />
                        ...
                        <g id="rightSide" className="side" style={{transformOrigin: "right"}}>
                            <path id="outerRight" d="M256,256.5v-.5c-333.3-361-333.3,361.6,0,.5Z" fill="#ea7f7a" />
                            <path id="innerRight" d="M26,256.3c0-18.5,4.1-36.6,11.5-51c5.2-10.1,14.8-23.4,30.9-29.7c17.4-6.8,39-4.4,64.3,7.1c29.1,13.3,61.3,38,96,73.6-34.7,35.6-66.9,60.3-96,73.6-25.2,11.5-46.9,13.9-64.3,7.1-16.1-6.3-25.7-19.6-30.9-29.7-7.4-14.4-11.5-32.5-11.5-51Z" fill="#e0433a" />
